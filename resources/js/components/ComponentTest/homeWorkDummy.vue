<template>
    <div>
        <div class="d-flex m-4 pl-4">
            <workListing class="m-3" :work="dummyWork" :author="dummyAuthor" :rating="dummyRating" 
            :colorProp="colors[Math.floor(Math.random() * colors.length)]" :styleType="1"></workListing>

            <workListing class="m-3" :work="dummyWork" :author="dummyAuthor" :rating="dummyRating2" 
            :colorProp="colors[Math.floor(Math.random() * colors.length)]"
            :styleType="1"></workListing>

            <workListing class="m-3" :work="dummyWork" :author="dummyAuthor" :rating="dummyRating3" 
            :colorProp="colors[Math.floor(Math.random() * colors.length)]"
            :styleType="1"></workListing>
